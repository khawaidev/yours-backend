#!/usr/bin/env node
/**
 * Creates the `public.gifts` table in Supabase via the Management API.
 *
 * Usage:
 *   SUPABASE_ACCESS_TOKEN=sbp_xxx node create-gifts-table.js
 *   node create-gifts-table.js sbp_xxx
 */
const fs = require('fs');
const path = require('path');

const REF = 'dgbxcakkqrgrapwsvrol';
const sqlPath = path.join(__dirname, 'src', 'db', 'gifts.sql');
